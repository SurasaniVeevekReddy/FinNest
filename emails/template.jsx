...
//             {data?.insights && (
//               <Section style={styles.section}>
//                 <Heading style={styles.heading}>FinNest Insights</Heading>
...
//               Thank you for using FinNest. Keep tracking your finances for better
//               financial health!
//             </Text>
//           </Container>
//         </Body>
...
export default function EmailTemplate({
  ...
  if (type === "budget-alert") {
    ...
    const percentUsed = data?.percentageUsed || 0;
      ...
      <Html>
        ...
        <Body style={styles.body}>
          <Container style={styles.container}>
            ...
            <Text style={styles.text}>Hello {userName},</Text>
            <Text style={styles.text}>
              You’ve used {percentUsed.toFixed(1)}% of your monthly budget.
            </Text>
            <Section style={styles.statsContainer}>
              <Section style={styles.stat}>
                <Text style={styles.text}>Budget Amount</Text>
